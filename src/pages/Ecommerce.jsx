...
import { earningData, medicalproBranding, recentTransactions, weeklyStats, dropdownData, ecomPieChartData, SparklineAreaData } from '../data/dummy';
  ...
  return (
    <div className='mt-12'>
        ...
        <div>
          ...
          >
            <div className='flex justify-between items-center'>
              ...
              <div>
                <p className='text-2xl text-white font-semibold mt-8'>₹85,125.00</p>
          ...
          <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl md:w-400 p-8 m-3 flex justify-center items-center gap-10'>
            <div>
              <p className='text-2xl font-semibold'>₹85,125.00</p>
      ...
      <div className='flex gap-10 m-4 flex-wrap justify-center'>
                ...
                <div className='flex justify-between mt-4' key={index}>
                  <div className='flex gap-4'>
                    <button 
                      ...
                      className="text-2xl p-4 rounded-lg hover:drop-shadow-xl"
                    >
                      {item.icon}
                    </button>
                    <div>
        ...
        <div className='bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-3xl w-96 md:w-760'>
          ...
          <div className='border-b-1 border-color pb-4 mt-2'>
            ...
            <div className='flex gap-4'>
              {medicalproBranding.teams.map((item) => (
                <p 
                  key={item.name} 
                  className="rounded-lg px-3 py-0.5 text-xs text-white cursor-pointer hover:drop-shadow-xl"
